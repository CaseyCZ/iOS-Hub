...
troubleNightlyQ:'SideStore nightly is unstable or suddenly broke', troubleNightlyA:'SideStore official troubleshooting says nightly builds may contain unstable bleeding-edge changes. If a problem appears only on nightly, switch to the latest stable build before deeper troubleshooting.',
...
troubleNightlyQ:'SideStore nightly je nestabilní nebo náhle přestal fungovat', troubleNightlyA:'Oficiální troubleshooting SideStore upozorňuje, že nightly buildy mohou obsahovat nestabilní nové změny. Pokud se problém objevuje jen na nightly, před další diagnostikou přejdi na nejnovější stable build.',
...
troubleNightlyQ:'SideStore Nightly ist instabil oder funktioniert plötzlich nicht mehr', troubleNightlyA:'Die offizielle SideStore-Fehlerbehebung weist darauf hin, dass Nightly-Builds instabile neue Änderungen enthalten können. Tritt das Problem nur im Nightly auf, wechsle zuerst zum neuesten Stable-Build.',
...
troubleNightlyQ:'SideStore nightly es inestable o dejó de funcionar de repente', troubleNightlyA:'La guía oficial de SideStore advierte que las builds nightly pueden incluir cambios experimentales inestables. Si el problema solo aparece en nightly, cambia primero a la última versión estable.',
