...
const SETUP_RESULTS = {
  en: {
    ...
    pairingNeeded:{title:'iOS 17–26 without a PC: pairing file required',text:'SideInstaller has partial support on iOS 17–26, but it requires an existing pairing file created with a computer. If you do not already have one, you need access to a computer once.',steps:['Check whether you already have a valid pairing file.','If not, create one with iloader on a computer.','Then use SideInstaller or SideStore with that pairing data.'],primary:'SideInstaller v1 release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0',secondary:'SideStore pairing guide ↗',secondaryUrl:'https://docs.sidestore.io/docs/advanced/pairing-file'},
    checkVersionNoPc:{title:'Check your iOS version first',text:'The exact path depends on your system version. iOS 27 can use SideInstaller fully on-device. iOS 17–26 can use SideInstaller only when a pairing file already exists.',steps:['Open Settings → General → About.','Check the exact iOS/iPadOS version.','Choose iOS 27 or iOS 17–26 in this wizard.'],primary:'SideInstaller v1 release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0'},
  ...
  cs: {
    ...
    pairingNeeded:{title:'iOS 17–26 bez PC: je potřeba pairing soubor',text:'SideInstaller má na iOS 17–26 částečnou podporu, ale vyžaduje existující pairing soubor vytvořený pomocí počítače. Pokud ho ještě nemáš, potřebuješ jednorázově přístup k počítači.',steps:['Ověř, jestli už máš platný pairing soubor.','Pokud ne, vytvoř ho přes iloader na počítači.','Potom můžeš SideInstaller nebo SideStore použít s těmito pairing daty.'],primary:'SideInstaller v1 release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0',secondary:'Návod k pairingu SideStore ↗',secondaryUrl:'https://docs.sidestore.io/docs/advanced/pairing-file'},
    checkVersionNoPc:{title:'Nejdřív zjisti přesnou verzi iOS',text:'Přesná cesta závisí na verzi systému. Na iOS 27 funguje SideInstaller kompletně přímo v zařízení. Na iOS 17–26 funguje jen s už existujícím pairing souborem.',steps:['Otevři Nastavení → Obecné → Informace.','Zjisti přesnou verzi iOS/iPadOS.','V průvodci pak vyber iOS 27 nebo iOS 17–26.'],primary:'SideInstaller v1 release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0'},
  ...
  de: {
    ...
    pairingNeeded:{title:'iOS 17–26 ohne PC: Pairing-Datei erforderlich',text:'SideInstaller unterstützt iOS 17–26 teilweise, benötigt dafür aber eine bereits mit einem Computer erstellte Pairing-Datei. Wenn du noch keine hast, brauchst du einmal Zugang zu einem Computer.',steps:['Prüfen, ob bereits eine gültige Pairing-Datei vorhanden ist.','Falls nicht, mit iloader auf einem Computer erstellen.','Danach SideInstaller oder SideStore mit diesen Pairing-Daten verwenden.'],primary:'SideInstaller v1 Release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0',secondary:'SideStore Pairing-Anleitung ↗',secondaryUrl:'https://docs.sidestore.io/docs/advanced/pairing-file'},
    checkVersionNoPc:{title:'Zuerst die genaue iOS-Version prüfen',text:'Der genaue Weg hängt von der Systemversion ab. Unter iOS 27 funktioniert SideInstaller vollständig auf dem Gerät. Unter iOS 17–26 funktioniert es nur mit einer bereits vorhandenen Pairing-Datei.',steps:['Einstellungen → Allgemein → Info öffnen.','Genaue iOS/iPadOS-Version prüfen.','Danach im Assistenten iOS 27 oder iOS 17–26 auswählen.'],primary:'SideInstaller v1 Release ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0'},
  ...
  es: {
    ...
    pairingNeeded:{title:'iOS 17–26 sin PC: se necesita archivo de pairing',text:'SideInstaller tiene compatibilidad parcial con iOS 17–26, pero necesita un archivo de pairing existente creado con un ordenador. Si todavía no lo tienes, necesitas acceso a un ordenador una vez.',steps:['Comprueba si ya tienes un archivo de pairing válido.','Si no, créalo con iloader en un ordenador.','Después usa SideInstaller o SideStore con esos datos de pairing.'],primary:'Release v1 de SideInstaller ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0',secondary:'Guía de pairing SideStore ↗',secondaryUrl:'https://docs.sidestore.io/docs/advanced/pairing-file'},
    checkVersionNoPc:{title:'Comprueba primero tu versión exacta de iOS',text:'La ruta exacta depende de la versión del sistema. En iOS 27, SideInstaller funciona completamente en el dispositivo. En iOS 17–26 solo funciona si ya existe un archivo de pairing.',steps:['Abre Ajustes → General → Información.','Comprueba la versión exacta de iOS/iPadOS.','Después elige iOS 27 o iOS 17–26 en este asistente.'],primary:'Release v1 de SideInstaller ↗',url:'https://github.com/FrizzleM/SideInstaller/releases/tag/v1.0.0'},
