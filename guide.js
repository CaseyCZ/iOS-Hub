...
GUIDE_RECOMMENDATIONS.de = {
  iphone:{title:'SideStore für Refresh direkt auf dem iPhone',text:'Für eigene IPA-Dateien mit möglichst wenig Computernutzung nach der Einrichtung starte mit SideStore. Unter iOS 27 kann SideInstaller die erste Installation von SideStore oder SideStore + LiveContainer direkt auf dem Gerät durchführen.',steps:['Mit Wi-Fi verbinden und LocalDevVPN aktivieren.','Unter iOS 27 SideInstaller verwenden, auf anderen unterstützten Versionen das normale SideStore-Setup.','Vor Ablauf der kostenlosen Signatur aktualisieren.'],primary:'SideStore-Doku öffnen ↗',url:'https://docs.sidestore.io/',secondary:'SideInstaller ↗',secondaryUrl:'https://sideinstaller.net/'},
...
GUIDE_RECOMMENDATIONS.es = {
  iphone:{title:'SideStore para renovar desde el iPhone',text:'Para tus propios IPA con el mínimo uso de ordenador tras la configuración, empieza con SideStore. En iOS 27, SideInstaller puede hacer la instalación inicial de SideStore o SideStore + LiveContainer directamente en el dispositivo.',steps:['Conecta Wi-Fi y activa LocalDevVPN.','En iOS 27 usa SideInstaller; en otras versiones compatibles usa la configuración normal de SideStore.','Renueva antes de que caduque la firma gratuita.'],primary:'Abrir guía SideStore ↗',url:'https://docs.sidestore.io/',secondary:'SideInstaller ↗',secondaryUrl:'https://sideinstaller.net/'},
...
GUIDE_RECOMMENDATIONS.fr = {
  iphone:{title:'SideStore pour actualiser depuis l’iPhone',text:'Pour vos propres IPA avec le moins possible d’utilisation de l’ordinateur après la configuration, commencez par SideStore. Sous iOS 27, SideInstaller peut effectuer l’installation initiale de SideStore ou SideStore + LiveContainer directement sur l’appareil.',steps:['Connecter le Wi-Fi et activer LocalDevVPN.','Sous iOS 27 utiliser SideInstaller ; sur les autres versions compatibles utiliser la configuration SideStore normale.','Actualiser avant l’expiration de la signature gratuite.'],primary:'Ouvrir le guide SideStore ↗',url:'https://docs.sidestore.io/',secondary:'SideInstaller ↗',secondaryUrl:'https://sideinstaller.net/'},
